...
class AiConfig:
    ...
    def from_env(cls) -> "AiConfig":
        return cls(
            ...
            retrieval_vector_weight=float(os.getenv("TENDER_AI_VECTOR_WEIGHT", cls.retrieval_vector_weight)),
            retrieval_lexical_weight=float(os.getenv("TENDER_AI_LEXICAL_WEIGHT", cls.retrieval_lexical_weight)),
            vector_scan_limit=max(100, int(os.getenv("TENDER_AI_VECTOR_SCAN_LIMIT", cls.vector_scan_limit))),
