...
| BL-003 | P2 | [Add minimum-sample confidence state to region status](https://github.com/Sintagmatarches/applied-ai-lab/issues/6) | Implemented; issue closed with release evidence | BL-001 |
...
| BL-006 | P2 | [Persist a governed rolling 7-day regional view](https://github.com/Sintagmatarches/applied-ai-lab/issues/9) | Implemented; issue closed with release evidence | BL-002, BL-005 |
