...
| BR-02 selectable threshold | BL-001 / CR-001 | `lib/rail-monitoring.ts`, `regional-monitor.tsx`, `rail/build_regional_history.py` | threshold-policy test in `tests/rail-monitoring.test.ts` | CR-001, release note |
...
| BR-07 partition quality gate | BL-002 / INC-001 | `rail/pipeline.py`, Fabric notebooks 01/02 | three partition-gate tests in `rail/tests/test_pipeline.py` | `docs/incidents/INC-001-empty-daily-partition.md` |
